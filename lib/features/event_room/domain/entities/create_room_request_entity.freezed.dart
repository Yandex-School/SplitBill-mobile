...
class _$CreateRoomRequestEntityImpl extends _CreateRoomRequestEntity {
  _$CreateRoomRequestEntityImpl({required this.name}) : super._();
  ...
  @override
  String toString() {
    return 'CreateRoomRequestEntity(name: $name)';
  }
...
abstract class _CreateRoomRequestEntity extends CreateRoomRequestEntity {
  factory _CreateRoomRequestEntity({required final String name}) =
      _$CreateRoomRequestEntityImpl;
  _CreateRoomRequestEntity._() : super._();
